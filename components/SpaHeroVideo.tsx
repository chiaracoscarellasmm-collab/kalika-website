...
type Props = {
  ...
  scrollHref?: string;
  navAriaLabel?: string;
  /** "label" = short uppercase gold line (SPA). "text" = readable subtitle (Estetica). */
  subtitleVariant?: "label" | "text";
};
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col justify-center px-6 py-28">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center text-center">
          ...
          {subtitleVariant === "label" ? (
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-[var(--color-cream)]/85 sm:text-lg sm:leading-8">
              {subtitle}
            </p>
          )}
